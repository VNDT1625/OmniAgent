...
/**
 * Shared section container for the Company page.
 *
 * Renders a titled card with a leading icon, optional subtitle, and an optional
 * trailing slot. Styling is built entirely from semantic UnoCSS tokens so it
 * adapts to both light and dark themes (mirrors the Resource Dashboard card).
 */
