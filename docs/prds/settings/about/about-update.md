...
5. 版本号旁有 GitHub 图标，点击在系统浏览器中打开项目仓库 `https://github.com/VNDT1625/OmniAgent`
...
| 序号 | 标题     | 行为               | 目标                                             |
| ---- | -------- | ------------------ | ------------------------------------------------ |
| 1    | 帮助文档 | 打开外部链接       | `https://github.com/VNDT1625/OmniAgent/wiki`     |
| 2    | 更新日志 | 打开外部链接       | `https://github.com/VNDT1625/OmniAgent/releases` |
| 3    | 意见反馈 | 打开外部链接       | `https://github.com/VNDT1625/OmniAgent/issues`   |
| 4    | 问题报告 | **打开应用内弹窗** | FeedbackReportModal（见 F-ABOUT-11）             |
| 5    | 联系我   | 打开外部链接       | `https://x.com/WailiVery`                        |
| 6    | 官网     | 打开外部链接       | `https://github.com/VNDT1625/OmniAgent`          |
