...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <strong>Español</strong> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.omni.com" target="_blank">Sitio oficial</a>
</p>

<p align="center">
  <strong>💬 Comunidad:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-9.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/Omni" target="_blank">Twitter</a>
</p>
...
[🤔 ¿Por qué elegir Omni?](#-por-qué-elegir-omni-sobre-claude-cowork) ·
...
**Omni es más que un cliente de chat.** Es una plataforma Cowork donde los AI Agents trabajan contigo en tu computadora — leyendo archivos, escribiendo código, navegando por la web y automatizando tareas. Puedes ver todo lo que hace el Agent y siempre tienes el control.

|                                             | Clientes de chat AI tradicionales | **Omni (Cowork)**                                                                                                                  |
| :------------------------------------------ | :-------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
...
Omni viene con un motor de Agent AI completo. A diferencia de las herramientas que requieren instalar CLI Agents por separado, **Omni funciona en el momento en que lo instalas**.
...
Otras apps de AI te dan una caja de chat con tu clave API. **Omni te da un Cowork Agent completo.**
...
Las mismas capacidades del Agent — lectura/escritura de archivos, búsqueda web, generación de imágenes, uso de herramientas — independientemente del modelo que lo impulse. Omni admite **30+ plataformas AI** incluyendo servicios en la nube y despliegues locales.
...
Omni también admite el servicio de puerta de enlace [NewAPI](https://github.com/QuantumNous/new-api) — un centro unificado de modelos AI que agrega y distribuye varios LLMs. Cambia flexiblemente entre diferentes modelos en la misma interfaz para satisfacer diversos requisitos de tareas.
...
- **Habilidades de tres niveles** — Habilidades integradas (incluidas con Omni), habilidades personalizadas (las tuyas) y habilidades de Extension (aportadas por extensiones de terceros); habilita/deshabilita por conversación con el indicador de habilidades
...
Omni incluye **21 asistentes profesionales** con capacidades predefinidas, extensibles a través de habilidades personalizadas:
...
**Habilidades personalizadas**: Crea habilidades en el directorio `skills/`, habilita/deshabilita habilidades para asistentes para extender las capacidades AI. Las habilidades provienen de tres fuentes: integradas (incluidas con Omni), personalizadas (las tuyas) y Extension (aportadas a través del SDK de Extension). Las habilidades integradas incluyen `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` y más.
...
_Tu asistente AI 24/7 — accede a Omni desde cualquier dispositivo, en cualquier lugar._
...
> **Configuración:** Omni Settings → WebUI Settings → Channel, configura el Bot Token.
...
- **Evitar suspensión** — Omni previene automáticamente la suspensión del sistema mientras las tareas están activas y detecta activaciones perdidas tras el despertar
...
## 🤔 ¿Por qué elegir Omni sobre Claude Cowork?
...
Omni es un **Escritorio Multi-AI Agent gratuito y de código abierto**. En comparación con Claude Cowork que solo se ejecuta en macOS y está bloqueado a Claude, Omni es su versión mejorada de modelo completo y multiplataforma.

| Dimensión          | Claude Cowork     | Omni                                                   |
| :----------------- | :---------------- | :----------------------------------------------------- |
...
R: <strong>No.</strong> Omni tiene un AI Agent integrado que funciona inmediatamente después de la instalación. Solo inicia sesión con Google o ingresa cualquier clave API. Si también tienes herramientas CLI como Claude Code o Gemini CLI instaladas, Omni las detectará e integrará automáticamente para aún más capacidades.
</details>

<details>
<summary><strong>P: ¿Qué puedo hacer con Omni?</strong></summary>
...
R: Omni es completamente gratuito y de código abierto. Puedes iniciar sesión con Google para usar Gemini gratis, o usar claves API de cualquier proveedor que prefieras.
</details>
...
> **¿Hiciste un video sobre Omni?** [Avísanos en X](https://x.com/Omni) y lo destacaremos aquí!
