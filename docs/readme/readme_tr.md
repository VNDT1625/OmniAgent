...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <strong>Türkçe</strong> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.omni.com" target="_blank">Resmi Web Sitesi</a>
</p>

<p align="center">
  <strong>💬 Topluluk:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-9.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/Omni" target="_blank">Twitter</a>
</p>
...
[🤔 Neden Omni'yi Seçmelisiniz?](#-neden-omni-claude-cowork-yerine) ·
...
**Omni sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **Omni (Cowork)**                                                                                                               |
| :------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------ |
...
Omni tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **Omni kurduğunuz anda çalışır**.
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **Omni size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. Omni bulut hizmetleri ve yerel dağıtımlar dahil **30+ AI platformunu** destekler.
...
Omni ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
- **Üç katmanlı Beceriler** — Yerleşik beceriler (Omni ile birlikte gelen), özel beceriler (kendinizinkiler) ve Extension becerileri (üçüncü taraf uzantılar tarafından katkıda bulunulan); beceri göstergesi ile konuşma başına etkinleştirin/devre dışı bırakın
...
Omni önceden tanımlanmış yeteneklere sahip **21 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — Omni'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** Omni Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
- **Uyanık kal** — Omni görevler aktifken sistem uyku moduna geçmeyi otomatik olarak önler ve uyandıktan sonra kaçırılan tetikleyicileri algılar
...
## 🤔 Neden Omni, Claude Cowork Yerine?
...
Omni **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, Omni tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | Omni                                              |
| :-------------- | :------------ | :------------------------------------------------ |
...
C: <strong>Hayır.</strong> Omni kurulumdan hemen sonra çalışan yerleşik bir AI Agent'a sahiptir. Sadece Google ile giriş yapın veya herhangi bir API anahtarı girin. Ayrıca Claude Code veya Gemini CLI gibi CLI araçlarınız da kuruluysa, Omni bunları otomatik olarak algılayacak ve daha fazla yetenek için entegre edecektir.
</details>

<details>
<summary><strong>S: Omni ile ne yapabilirim?</strong></summary>
C: Omni sizin <strong>özel Cowork çalışma alanınızdır</strong>. Yerleşik Agent klasörleri toplu olarak organize edebilir, Excel verilerini işleyebilir, belgeler oluşturabilir, web'de arama yapabilir ve görüntüler oluşturabilir. Çoklu Agent Modu ile aynı arayüz üzerinden Claude Code, Codex ve diğer güçlü CLI Agent'larından da yararlanabilirsiniz.
</details>

<details>
<summary><strong>S: Ücretsiz mi?</strong></summary>
C: Omni tamamen ücretsiz ve açık kaynaklıdır. Gemini'yi ücretsiz kullanmak için Google ile giriş yapabilir veya tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların Omni'yi Nasıl Kullandığını Görün
...
> **Omni hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/Omni) ve burada öne çıkaralım!
