...
cd ../AionCore && cargo install --path crates/omni-app
...
| ---------------------------- | ----- | ------------------------ |
| `OMNI_E2E_TEST`            | `1`   | App recognizes test mode |
| `OMNI_DISABLE_AUTO_UPDATE` | `1`   | No update checks         |
| `OMNI_DISABLE_DEVTOOLS`    | `1`   | No DevTools windows      |
| `OMNI_CDP_PORT`            | `0`   | CDP disabled             |
...
```bash
# Clean via database
sqlite3 "~/Library/Application Support/Omni-Dev/omni/omni.db" \
