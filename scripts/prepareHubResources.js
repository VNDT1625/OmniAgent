...
const BASE_URLS = [
  `https://raw.githubusercontent.com/VNDT1625/OmniAgent/${process.env.AIONUI_HUB_TAG || DEFAULT_TAG}/`,
  `https://cdn.jsdelivr.net/gh/VNDT1625/OmniAgent@${process.env.AIONUI_HUB_TAG || DEFAULT_TAG}/`,
];
